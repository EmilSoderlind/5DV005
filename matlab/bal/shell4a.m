...
% SHELL4A Computes the forces on a point mass artillery shell moving in 2D
...
if isfield(param,'wind')
    % Compute the wind as a function of time and position
    w=param.wind(t,x);     
...
% Evaluate the drag coefficient and compute k such that friction size = k*v^2
k=0.5*A*param.drag(ma).*rho;

%--------------------------------------------------------------------------
% Extract the mass, and gravity from PARAM
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% Compute the derivatives of the position and the velocity
%--------------------------------------------------------------------------

% The derivative of the position is the velocity relative to the ground
z(1)=x(3); 
z(2)=x(4);
...
%**************************************************************************
% Friction forces depend on the velocity of the shell relative to the wind
%**************************************************************************
