function [t, y, count, idx]=el(f,t0,t1,y0,maxstep,method,g,K)

% EL Event location for ordinary differential equations
%
...
% CALL SEQUENCE:
%
%    [t, y, count, idx]=el(f,t0,t1,y0,N,method,g,K)
%
% INPUT:
...
% 
% The script EL_MWE1 fires as gun and track the shell to the point
% of impact where the y coordinate of the shell equals zero.
%
% See also: RK
...
% TODO: SCORCED reveals that there are unresolved problems as shells can
...
for i=1:maxstep
    ...
    if s0==0
        ...
        if (s0*s1==-1)
            ...
            rho=bisection(psi,0,1,g0,g1,2^-54*tau,1e-15,60);
            
            % STUDENT PROBLEMS:
            %  a) Develop sensible termination criteria.
            %  b) Replace solver with user defined routine.
            %  c) Record iteration counts to document improvement.
